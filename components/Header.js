...
import { emptyHiddenArticles } from '../reducers/hiddenArticles';
...
function Header() {
	...
	const handleRegister = () => {
		fetch('https://morningnews-backend-eight.vercel.app/users/signup', {
			method: 'POST',
	...
	const handleConnection = () => {
		...
		fetch('https://morningnews-backend-eight.vercel.app/users/signin', {
			method: 'POST',
			headers: { 'Content-Type': 'application/json' },
	...
	const handleEmptyHiddenArticles = () => {
		dispatch(emptyHiddenArticles())
	}
		...
		if (isModalVisible) {
			...
			userSection =
				<div className={styles.headerIcons}>
					...
					<FontAwesomeIcon icon={faEye} onClick={() => handleEmptyHiddenArticles()} />
				</div>
		}
	}
